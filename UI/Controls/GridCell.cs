...
namespace Framework.Ajax.UI.Controls
{
	...
	{
        /// <summary>
        /// Contained AjaxControl
        /// </summary>
        protected AjaxControl mControl;
        ...
        /// <summary>
        /// Gets Inner AjaxControl
        /// </summary>
        public AjaxControl InnerControl { get { return mControl; } }
        /// <summary>
        ...
        public void RenderControl(AjaxTextWriter writer)
        {
        ...
        /// </summary>
        /// <param name="writer">Tag writer</param>
        public virtual void RenderSingle(AjaxTextWriter writer)
        {
        ...
        /// </summary>
        /// <param name="writer">Tag writer</param>
		public virtual void RenderCell(AjaxTextWriter writer)
		{
        ...
        public virtual void RenderCellJS(AjaxTextWriter writer)
        {
            if (!parentColumn.Visible)
                return;
