...
namespace nxAjax.UI.Controls
{
	...
	public class GridRow
	{
		...
		public void Render(nxAjaxTextWriter writer)
		{
            if (!mVisible)
                return;
        ...
        public void Render(nxAjaxTextWriter writer, TemplatePage template)
        {
            if (!mVisible)
                return;
        ...
        public void RenderJS(nxAjaxTextWriter writer)
        {
            foreach (GridCell gc in cells)
