...
{
    /// <summary>
    /// nxAjax framework Editable Combo Label control. It is a label, but when you enter in edit mode, it is a ComboBox.
    /// <code>
    /// &lt;ajax:EditableComboLabel runat="server"&gt;&lt;/ajax:EditableComboLabel&gt;
    /// </code>
    /// </summary>
    [AspNetHostingPermission(SecurityAction.Demand, Level = AspNetHostingPermissionLevel.Minimal)]
    [AspNetHostingPermission(SecurityAction.InheritanceDemand, Level = AspNetHostingPermissionLevel.Minimal)]
    [Designer("Framework.Ajax.UI.Design.AjaxControlDesigner")]
    [ToolboxData("<{0}:EditableComboLabel runat=server></{0}:EditableComboLabel>")]
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(System.Web.UI.WebControls.DropDownList))]
    public class EditableComboLabel : ComboBox, IEditableControl
    {
        ...
        public EditableComboLabel() : base() 
        { 
