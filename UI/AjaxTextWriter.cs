...
namespace Framework.Ajax.UI
{
    ...
    /// </summary>
    public class AjaxTextWriter : StringWriter
    {
        ...
        internal AjaxTextWriter() : this(new StringWriter())
		{
		}
        /// <summary>
        /// Contructor. Creates a new AjaxTextWriter object
        /// </summary>
        /// <param name="writer">source writer base</param>
		public AjaxTextWriter (TextWriter writer) : this (writer, DefaultTabString)
		{
		}
		...
		public AjaxTextWriter (TextWriter writer, string tabString)
		{
			b = writer;
