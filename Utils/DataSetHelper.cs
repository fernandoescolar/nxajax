...
{
    /// <summary>
    /// Group of helper functions for DataSet object
    /// </summary>
    public class DataSetHelper
    {
        #region SupportClass: FieldInfo
        ...
        #region Private & Public Attributes
        ...
        #region Factory
        /// <summary>
        /// Create a new DataSetHelper
        /// </summary>
        /// <param name="DataSet">DataSet object source</param>
        public DataSetHelper(ref DataSet DataSet)
        {
            ds = DataSet;
        }
        /// <summary>
        /// Creates an empty DataSetHelper
        /// </summary>
        ...
        /// </summary>
        /// <param name="TableName">Data Table, table name</param>
        /// <param name="SourceTable">Source DataTable</param>
        /// <param name="FieldList">Syntax: fieldname[ alias]|aggregatefunction(fieldname)[ alias], ...</param>
        ...
        #region InsertGroupByInto
        /// <summary>
        /// Copies the selected rows and columns from SourceTable and inserts them into DestTable
        /// 
        /// FieldList Supported Operators: count,sum,max,min,first,last
        /// </summary>
        /// <param name="DestTable">Destination DataTable</param>
        /// <param name="SourceTable">Source DataTable</param>
        /// <param name="FieldList">Syntax: fieldname[ alias]|aggregatefunction(fieldname)[ alias], ...</param>
        /// <param name="RowFilter">Conditional expresion (ej: ID=5)</param>
        ...
        public void InsertGroupByInto(DataTable DestTable, DataTable SourceTable, string FieldList, string RowFilter, string GroupBy)
        {
            /*
             * Copies the selected rows and columns from SourceTable and inserts them into DestTable
             * FieldList has same mFormat as CreateGroupByTable
            */
            if (FieldList == null)
                throw new ArgumentException("You must specify at least one field in the field list.");
        ...
        #region SelectGroupByInto
        /// <summary>
        /// Selects data from one DataTable to another and performs various aggregate functions
        /// along the way. FieldList Supported Operators: count,sum,max,min,first,last
        /// </summary>
        /// <param name="TableName">Data Table, table name</param>
        /// <param name="SourceTable">Source DataTable</param>
        /// <param name="FieldList">Syntax: fieldname[ alias]|aggregatefunction(fieldname)[ alias], ...</param>
