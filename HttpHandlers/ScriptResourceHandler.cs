...
/// </summary>
namespace Framework.Ajax.HttpHandlers
{
    /// <summary>
    ...
    public class ScriptResourceHandler : System.Web.IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
                ...
                using (MemoryStream memoryStream = new MemoryStream(5000))
                {
                    ...
                    using (Stream writer = isCompressed ? (Stream)(new GZipStream(memoryStream, CompressionMode.Compress)) : memoryStream)
                    {
                        ...
                        if (setName == "AjaxScripts")
                        {
                            ...
                            {
                                System.IO.Stream reader = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Framework.Ajax." + fileName);
            ...
            //            System.IO.Stream reader = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("Framework.Ajax." + script);
